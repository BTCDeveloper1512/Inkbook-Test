...
const STATIC_FAQS = [
  {
    ...
    items: [
      ...
      { q: "Wie erkenne ich verifizierte Studios?", a: "Verifizierte Studios tragen ein blaues Verified-Badge auf ihrer Profilkarte. Diese Studios wurden von StudioOS geprüft und erfüllen unsere Qualitätsstandards." },
      { q: "Ist StudioOS für Kunden kostenlos?", a: "Ja, vollständig kostenlos! Du kannst alle Funktionen nutzen – Suchen, Vergleichen, Buchen, Nachrichten senden und Videoberatungen – ohne jede Gebühr." },
      { q: "Bekomme ich Erinnerungen an meinen Termin?", a: "Ja. StudioOS sendet automatische Erinnerungsmails vor deinem Termin. Alle kommenden Termine siehst du übersichtlich im Dashboard." },
      ...
      { q: "Kann ich StudioOS auf dem Handy nutzen?", a: "Ja, StudioOS ist vollständig responsiv und für mobile Geräte optimiert. Du kannst direkt im Browser buchen – ohne App-Download. Eine native App ist in Planung." },
      { q: "In welchen Städten ist StudioOS verfügbar?", a: "StudioOS ist deutschlandweit verfügbar. Das Netzwerk wächst stetig – wenn dein Wunschstudio noch nicht dabei ist, empfiehl ihnen StudioOS!" },
    ],
  },
  {
    ...
    items: [
      ...
      { q: "Was bedeutet das Verified-Badge und wie bekomme ich es?", a: "Das Badge zeigt Kunden, dass dein Studio von StudioOS geprüft wurde. Kontaktiere den StudioOS-Support mit deinen Studio-Dokumenten. Die Prüfung dauert in der Regel 2–3 Werktage." },
      ...
      { q: "Werden Kunden automatisch an Termine erinnert?", a: "Ja. StudioOS versendet automatische Erinnerungsmails – weniger No-Shows für dein Studio, ohne Aufwand deinerseits." },
      { q: "Was kostet StudioOS für Studios?", a: "StudioOS bietet ein monatliches Abonnement für Studios an. Die genauen Preise findest du auf der Preisseite oder direkt im Studio-Dashboard." },
