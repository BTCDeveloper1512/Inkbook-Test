...
class Media {
  constructor({
    geometry, gl, image, index, length,
    renderer, scene, screen, viewport,
    bend, borderRadius = 0, scrollSpeed
  }) {
    this.extra = 0;
...
class App {
  ...
  onTouchUp(e) {
    ...
    if (moved < 8 && this.onItemClick && this.medias && this.medias.length > 0) {
      let closest = null;
      ...
      if (closest) {
        const originalIndex = closest.index % this.originalLength;
  ...
  addEventListeners() {
    ...
    // Bind mousedown/touchstart to container only
    this.container.addEventListener('mousedown', this.boundOnTouchDown);
    this.container.addEventListener('touchstart', this.boundOnTouchDown, { passive: true });
    this.container.addEventListener('wheel', this.boundOnWheel, { passive: false });
    // Move/up bind to window so drag works outside
...
export default function CircularGallery({
  ...
  }, [JSON.stringify(items), bend, borderRadius, scrollSpeed, scrollEase]);
